...
cp libppuc/libppuc/build/${BUILD_TYPE}/libppuc.lib ../third-party/build-libs/windows-x64/
cp libppuc/libppuc/build/${BUILD_TYPE}/libppuc.dll ../third-party/runtime-libs/windows-x64/
cp -a libppuc/libppuc/third-party/runtime-libs/windows/x64/libyaml-cpp.lib ../third-party/build-libs/windows-x64/
cp -a libppuc/libppuc/third-party/runtime-libs/windows/x64/libyaml-cpp.dll ../third-party/runtime-libs/windows-x64/
