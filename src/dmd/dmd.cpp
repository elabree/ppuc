...
UINT8 DmdDefaultPalette2Bit[12] = {0,   0,  0, 144, 34,  0,
                                   192, 76, 0, 255, 127, 0};
UINT8 DmdDefaultPalette4Bit[48] = {
...
void dmdConvertToFrame(UINT16 width, UINT16 height, UINT8* frame, UINT8* planes,
                       int bitDepth) {
  UINT8 bitMask = 1;
  UINT32 tj = 0;
...
void dmdConsoleRender(UINT16 width, UINT16 height, UINT8* buffer,
                      int bitDepth) {
